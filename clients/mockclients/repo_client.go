...
func (mr *MockRepoClientMockRecorder) GetFileReader(filename any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// IsReleaseImmutable mocks base method.
func (m *MockRepoClient) IsReleaseImmutable(owner, repo, tag string) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IsReleaseImmutable", owner, repo, tag)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// IsReleaseImmutable indicates an expected call of IsReleaseImmutable.
func (mr *MockRepoClientMockRecorder) IsReleaseImmutable(owner, repo, tag any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsReleaseImmutable", reflect.TypeOf((*MockRepoClient)(nil).IsReleaseImmutable), owner, repo, tag)
}
